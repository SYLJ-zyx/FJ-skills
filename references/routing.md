...
- `3d-animation`：3D、三维、CG、游戏电影感、三维动画电影质感；国漫未同时指定2D/二维时默认按3D国漫处理。
- `2d-anime`：2D、二维、2D国漫、二维国漫、日漫、日式动画、赛璐璐、漫画动态分镜。
...
| `vertical-short + 3d-animation` | `format-routes.md`、`camera-rules.md`、`visual-styles.md`、`output-format.md`；套用竖版短剧镜头与3D动画表演规则；若用户要求3D国漫、国漫、三维国风、3D竖版短剧、C4D/OC渲染或UE5影视光影，再读取 `vertical-9x16-3d-guoman.md` |
